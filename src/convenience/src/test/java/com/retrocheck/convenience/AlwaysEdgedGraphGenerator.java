...
public class AlwaysEdgedGraphGenerator extends Generator<DefaultGraph> {
    public AlwaysEdgedGraphGenerator() {
        super(DefaultGraph.class);
    }

    // Generate a graph that has no cycles and edges which are always chosen during traversal.
    @Override
    public DefaultGraph generate(
        ...
        for (int i = 0; i < edgeCount; i++) {
            ...
            Edge<Integer, Integer> edge = new Edge<>(u, v, (_u, _v) -> _u, Probability.ALWAYS);
            edges.add(edge);
